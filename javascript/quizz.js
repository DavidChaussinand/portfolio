...
function showResults(results) {
  ...
  const observations = [
    ...
    "Visionnaire et déterminé, vous avez une perspective élevée sur les situations, capable de voir le tableau d'ensemble tout en se concentrant sur des détails fins. Comme un aigle, vous êtes indépendant, ambitieux et possédez une forte concentration. Votre capacité à prendre des décisions éclairées fait de vous une référence dans votre domaine.Et je pourrais voler dans le ciel :) ",
